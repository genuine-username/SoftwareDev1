...
public class Objects {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // If the player is dead, then give the game over message and quit otherwise print health
            if (playerHealth <= 0) {
...
class Enemy {
    ...
    public void takeDamage(float damage) {
        ...
        if (health <= 0) {
            // The enemy has been defeated so print a message and then inform the code to kill it
